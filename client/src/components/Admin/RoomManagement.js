...
const RoomManagement = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('https://bridgeon-backend.onrender.com/api/rooms', {
        method: 'POST',
        headers: {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      const response = await fetch(
        `https://bridgeon-backend.onrender.com/api/rooms/${selectedRoom._id}`,
        {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json',
  ...
  const handleDelete = async (roomId) => {
    ...
    try {
      const response = await fetch(
        `https://bridgeon-backend.onrender.com/api/rooms/${roomId}`,
        {
          method: 'DELETE',
          headers: {
            Authorization: `Bearer ${user.token}`,
